"""Unit tests for cdc_fraud_cases_to_bronze.py."""
...
import cdc_fraud_cases_to_bronze as mod  # noqa: E402
...
class TestBuildSparkSession:
    def test_does_not_enable_hive_support(self):
        ...
        builder.appName.assert_called_once_with("cdc-fraud-cases-to-bronze")
...
class TestMain:
    def test_writes_parquet_not_delta(self):
        ...
        spark.conf.get.side_effect = lambda key: {
            ...
            "spark.bronze.fraud_cases.checkpoint.path": (
                "s3a://bronze/_checkpoints/cdc_fraud_cases_bronze"
            ),
